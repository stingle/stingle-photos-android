...
public class Camera2Activity extends Activity
	...
	private static final int STATE_STARTING_RECORDING = 5;
	private static final int STATE_STOPING_RECORDING = 6;
	...
	private View.OnClickListener toggleFlash() {
		return new View.OnClickListener() {
			public void onClick(View v) {
				...
				setFlashButtonImage();
				applyFlashMode(mPreviewRequestBuilder);
	...
	private void applyFlashMode(CaptureRequest.Builder builder){
		...
		if ((mState == STATE_PREVIEW || mState == STATE_RECORDING) && mFlashSupported) {
			...
			try {
				//mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_MODE, flashModeAE);
				...
				Log.d("Func", "appliedFlashMode - " + String.valueOf(flashMode));
    ...
    private void setUpCameraOutputs(int width, int height) {
		synchronized (mCameraStateLock) {
			...
			try {
				...
				//Toast.makeText(Camera2Activity.this, R.string.unexpected_error, Toast.LENGTH_SHORT);
			}
		}
    }
