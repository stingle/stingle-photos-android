...
public class KeyManagement {
	...
	public static boolean uploadKeyBundle(Context context, HttpsClient.OnNetworkFinish onFinish){
		HashMap<String, String> postParams = new HashMap<String, String>();

		String keyBundle;
		String publicKey;
		try {
			byte[] keyBundleBytes = SafeCameraApplication.getCrypto().exportKeyBundle();
