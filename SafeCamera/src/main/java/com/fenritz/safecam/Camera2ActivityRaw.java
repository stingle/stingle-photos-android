...
public class Camera2ActivityRaw extends Activity implements View.OnClickListener {
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice cameraDevice, int error) {
            ...
            Camera2ActivityRaw.this.finish();
        }
    ...
    private void captureStillPicture() {
        try {
            ...
            // Set orientation.
            int rotation = Camera2ActivityRaw.this.getWindowManager().getDefaultDisplay().getRotation();
            ...
            // of active requests.
            ImageSaver.ImageSaverBuilder jpegBuilder = new ImageSaver.ImageSaverBuilder(Camera2ActivityRaw.this).setCharacteristics(mCharacteristics);
            ImageSaver.ImageSaverBuilder rawBuilder = new ImageSaver.ImageSaverBuilder(Camera2ActivityRaw.this).setCharacteristics(mCharacteristics);
    ...
    private final Handler mMessageHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            Toast.makeText(Camera2ActivityRaw.this, (String) msg.obj, Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private boolean setUpCameraOutputs() {
        ...
        CameraManager manager = (CameraManager) Camera2ActivityRaw.this.getSystemService(Context.CAMERA_SERVICE);
        if (manager == null) {
    ...
    private boolean hasAllPermissionsGranted() {
        for (String permission : CAMERA_PERMISSIONS) {
            if (ActivityCompat.checkSelfPermission(Camera2ActivityRaw.this, permission)
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        synchronized (mCameraStateLock) {
            ...
            int deviceRotation = Camera2ActivityRaw.this.getWindowManager().getDefaultDisplay().getRotation();
            Point displaySize = new Point();
            Camera2ActivityRaw.this.getWindowManager().getDefaultDisplay().getSize(displaySize);
