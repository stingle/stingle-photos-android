...
public class OptimizedCipherInputStream extends FilterInputStream {
    ...
    private final byte[] ibuffer = new byte[1024*32];
     ...
     */
    public OptimizedCipherInputStream(InputStream is, Cipher c) {
        super(is);
        input = is;
        cipher = c;
    }
     ...
     * @param is the to-be-processed input stream
     */
    protected OptimizedCipherInputStream(InputStream is) {
        super(is);
        input = is;
